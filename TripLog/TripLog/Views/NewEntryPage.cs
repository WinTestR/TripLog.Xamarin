...
namespace TripLog.Views
{
	public class NewEntryPage : ContentPage
	{
		public NewEntryPage()
		{
			//going Ninject - BindingContext = new NewEntryViewModel(DependencyService.Get<INavService>(), null);
			...
			date.SetBinding(DatePickerEntryCell.TextProperty, "Date", BindingMode.TwoWay);
